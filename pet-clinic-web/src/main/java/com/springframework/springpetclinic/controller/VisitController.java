...
public class VisitController {
	...
	public Visit loadPetWithVisit(@PathVariable String petId, Map<String, Object> model) {
	...
	public String initNewVisitForm(@PathVariable String petId, Map<String, Object> model) {
